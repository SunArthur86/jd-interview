...
**30 秒电梯演讲：** 京东结算系统，凌晨跑一个批量更新事务，扫了 1000 万行。期间从库延迟 2 小时，上午业务报错锁等待超时

**展开框架：**
1. **大事务/长事务/锁等待的定义** — 大事务/长事务/锁等待的定义 —— 三者递进关系
2. **SHOW ENGINE INNODB STATUS** — SHOW ENGINE INNODB STATUS —— 必会诊断命令
3. **innodb_trx + lock_waits 联查** — innodb_trx + lock_waits 联查 —— 锁等待定位

**收尾：** 以上是我的整体思路。您想继续深入聊——大事务有什么危害？
