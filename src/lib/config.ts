...
export const APP_CONFIG = {
  ...
  subcatGroups: {
    ...
    'JD 核心技术':    ['Java 并发', 'JVM', 'Java 集合', 'Spring Cloud', 'Spring Boot', '微服务', 'MySQL', 'Redis', 'HBase', 'ES', 'Kafka', '分库分表', '供应链', '商品', '交易', '订单', '用户', '评价', '直播', '中台', '规则引擎', '特征工程', '实时计算', '风控系统', '数据隔离', '系统解耦', '分布式事务', 'Agent 编排', '记忆系统', '会话管理', '消息系统', '音视频任务', 'Prompt 工程', '内容审核', '模型路由', '工具调用', '埋点实验', 'IM 系统', '实时互动', '定时任务', '分布式调度', '文件存储', '对象存储', 'Workflow 引擎', 'Function Calling', 'MCP 协议', '向量数据库', '知识库', 'API 服务', '成本控制', '医药 AI'],
    '架构设计':       ['架构设计', '供应链架构', '交易架构', '多活容灾', '网关设计', '内容架构', '直播架构', 'Feed 流', '搜索架构', '中台架构', '风控架构设计', '特征平台设计', '决策引擎设计', '关系网络设计', '设备指纹设计', '安全架构', 'AI 陪伴架构', 'Agent 引擎架构', '记忆系统架构', '音视频平台架构', '消息社区架构', '长连接网关', '多租户 SaaS', '企业级 AI 平台架构', 'RAG 平台架构', '多模型路由架构', '医药数据治理'],
    '高并发高可用':   ['池化', '缓存', '扩容', '异步', '队列', '限流', '降级', '负载均衡', '隔离', '压测', '预案', '回滚', '可观测性', '稳定性治理', '高可用', '灰度发布'],
    'AI Agent/Infra': ['Agent 改造', 'Agent 架构', 'Agent 工程化', 'LLM 训练', 'LLM 推理', '模型服务', 'RAG 工程', '多模态', '实验平台', '智能风控', 'LLM 风控', 'GraphRAG', 'FDE 解决方案', 'AI Harness', 'LLM 接入工程', 'Tool Calling', '多模型编排', '数字人', 'TTS ASR', '视频生成', 'AI Coding', '向量检索', 'Java 转 AI', '国际化', '数据合规', 'Agent 框架', 'LLMOps', '医药知识图谱', 'B 端 Agent 交付', '企业级安全合规'],
